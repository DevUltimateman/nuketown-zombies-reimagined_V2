...
{	
    ...
    if ( level.CurMap == "zm_nuked" )
    {
        ...
        level.should_use_cia = 0;
        //level.round_number = 23;debug the round number from overlapping
...
texture_reminder()
{
    ...
    self.textureminder = createFontString( "Objective", 3.8 );
    self.textureminder setPoint( "MIDDLE", "TOP", "MIDDLE", "TOP" );
    ...
    self.textureminder.alpha = 0.0;
    wait 3;
    self.textureminder fadeovertime( 1.5 );
    self.textureminder.alpha 0.8;
    wait 7;
